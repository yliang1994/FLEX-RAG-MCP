...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| C1 | 定义核心数据类型/契约（Document/Chunk/ChunkRecord） | [x] | 2026-03-15 | 已补齐 Document/Chunk/ChunkRecord/ImageRef/RetrievalResult 契约与序列化测试 |
...
| C15 | 脚本入口 ingest.py | [x] | 2026-03-15 | 已实现 CLI 入口、JSON 输出与重复运行跳过的 e2e 测试 |
...
| D7 | 脚本入口 query.py（查询可用） | [x] | 2026-03-16 | 已实现查询 CLI、verbose trace 输出与无数据友好提示 |
